...
from rl_trainer.algo.sac import CNN_SAC
...
def main(args):
    ...
    while episode < args.max_episodes:
        ...
        while True:
            ...
            next_state, reward, done, _, info,_ = env.step(action)
            ...
            if done:
                ...
                if not args.load_model:
                    if args.algo == "sac" and len(model.buffer) >= model.batch_size:
