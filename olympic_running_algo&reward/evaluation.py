...
def run_game(env, algo_list, agent_list, episode, shuffle_map, map_num, render):
    ...
    for i in tqdm(range(1, int(episode) + 1)):
        ...
        while True:
            ...
            next_state, reward, done, _, info,_ = env.step(joint_action)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--my_ai_run_dir", default="best")
    parser.add_argument("--my_ai_run_episode", default=33000)
